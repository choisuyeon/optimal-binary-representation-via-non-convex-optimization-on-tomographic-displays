%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%    MATLAB code of non-convex optimization on tomographic near-eye displays 
%    https://doi.org/10.1038/s41467-019-10451-2
%    https://doi.org/10.1364/OE.27.024362
%
...
maxIter           = 50;       
binaryMaxIter     = 45;       
binaryMaxIterMask = 45;  
periodEPR         = 15;     

methodBinary      = 'PALM+PD';       % 'SART' or 'PALM+PD' or 'None'
methodContinuous  = 'PD';       % 'SART' or 'PD' or 'None'
